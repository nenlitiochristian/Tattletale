    ...
    return (
        <div className='flex items-center justify-center w-full h-full text-black dark:text-white'>
            <div className='flex flex-col gap-2 items-center justify-center p-12 bg-zinc-500  dark:bg-zinc-800 text-base rounded-lg'>
                ...
                <form className='flex flex-col gap-2 items-center justify-center bg-zinc-500  dark:bg-zinc-800 text-base rounded-lg' onSubmit={(e) => { e.preventDefault(); submit() }}>
                    <input type="password" placeholder='New password' className='rounded-md p-1 focus:ring-2 focus:ring-zinc-700 dark:focus:ring-zinc-500 focus:outline-none text-black bg-zinc-200'
                        onChange={(e) => { setPasswordData({ ...passwordData, newPassword: e.target.value }) }} value={passwordData.newPassword}
                    ></input>
                    <input type="password" placeholder='Re-enter new password' className='rounded-md p-1 focus:ring-2 focus:ring-zinc-700 dark:focus:ring-zinc-500 focus:outline-none text-black bg-zinc-200'
